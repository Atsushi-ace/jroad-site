  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <TextWithImage
        ...
        title="柔道界の課題と私たちの想い"
        text={
          'J-Roadは、単なるビジネスとしてのツーリズム事業ではありません。私たちは、日本の柔道界が直面している深刻な課題を認識し、本事業を通じてその解決に貢献したいと考えています。\n\n柔道は日本の伝統武術であり、世界に誇るべき文化です。しかし、現在の柔道界には多くの課題が存在しています。私たちは、これらの課題を解決するための一助となるべく、海外からの柔道家・柔道ファンを日本に迎え入れ、日本の柔道の素晴らしさを世界に伝えるとともに、柔道界に新たな活力をもたらしたいと考えています。\n\n以下に挙げる課題を、本事業を通じて解決したいと考えております。どうか暖かく見守っていただけますよう、お願い申し上げます。'
        }
