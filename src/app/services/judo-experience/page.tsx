    ...
    <div className="space-y-16 pb-16 relative">
      ...
      <div className="relative">
        <TextWithImage
          ...
          text="柔道体験は、柔道未経験の方や初心者の方を対象とした、1日で柔道の基礎と日本文化を体験できるプログラムです。\n\n日本の伝統的な道場で、柔道の基本動作（受け身、礼法、基本の技）を学びながら、柔道を通じて日本の「礼」や「精神性」に触れることができます。経験豊富な指導者が丁寧にサポートしますので、柔道を初めて体験する方でも安心してご参加いただけます。\n\n稽古の後は、道場での体験を振り返りながら、柔道の歴史や文化についても学ぶ時間を設けています。"
